...
use profilefield_learningstyles\entities\getlog as entitygetlog;
 ...
 */
class getlog extends system_report {
    ...
    protected function initialise(): void {
        ...
        $entitymain = new entitygetlog();
        $entitymainalias = $entitymain->get_table_alias('profilefield_ls_getlog');

        $this->set_main_table('profilefield_ls_getlog', $entitymainalias);
    ...
    public function add_columns(): void {
        $columns = [
            'getlog:difference',
            'getlog:localanswers',
            'getlog:remoteanswers',
            'getlog:timerequest',
        ];

        if ($this->adminreport) {
            $columns = array_merge(['getlog:id', 'getlog:userid'], $columns);
        }
    ...
    protected function add_filters(): void {
        ...
        if ($this->adminreport) {
            $filters = array_merge(['getlog:userid'], $filters);
        }
